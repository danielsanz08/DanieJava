...
public class Form02 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TxtNumeroUno.setBounds(20, 230, 120, 70);
        ...
        TxtResultado.setBounds(100, 420, 170, 30);
...
public boolean Numero (String numero){
    ...
    public void CalcularParImpar(){
        if(Numero(TxtNumeroUno.getText())){
            ...
            TxtResultado.setText((Num % 2 ==0) ? "Es par" : "Es impar");
            TxtResultado.setVisible(true);
            
            
            if(Num<=0){
                JOptionPane.showMessageDialog(this, "ERROR", "Aviso de Error", JOptionPane.ERROR_MESSAGE);
            }
        }
